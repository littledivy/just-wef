...
wef supports three kinds of menus: an application menu bar, per-window context
...
and wef swaps it as windows take focus. On Windows and Linux the menu is
